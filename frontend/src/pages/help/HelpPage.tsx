...
export function HelpPage() {
  ...
  return (
    <div className="max-w-3xl mx-auto text-[17px] leading-relaxed">
      ...
      {/* Sommaire (AC-1) */}
      <nav className="mb-8 bg-cream border border-sand rounded-lg p-4">
      ...
      <div className="space-y-10">
        ...
        {/* FAQ (AC-4) */}
        <section id="faq">
          <h2 className="text-lg font-semibold text-bark mb-3">Questions fréquentes (FAQ)</h2>

          <h3 className="text-base font-medium text-bark mt-4 mb-2">Inscription et compte</h3>
          <dl className="text-sm text-bark-light space-y-3">
            <div>
          ...
          <h3 className="text-base font-medium text-bark mt-6 mb-2">Articles et listes</h3>
          <dl className="text-sm text-bark-light space-y-3">
            <div>
          ...
          <h3 className="text-base font-medium text-bark mt-6 mb-2">Dépôt et vente</h3>
          <dl className="text-sm text-bark-light space-y-3">
            <div>
          ...
          <h3 className="text-base font-medium text-bark mt-6 mb-2">Paiement et reversement</h3>
          <dl className="text-sm text-bark-light space-y-3">
            <div>
        ...
        <section id="reglement">
          ...
          <div className="overflow-x-auto">
            <table className="text-sm text-bark-light w-full border-collapse">
              <thead>
        ...
        {isVolunteerOrAbove && (
          <section id="guide-benevole">
            <h2 className="text-lg font-semibold text-bark mb-3">Guide bénévole</h2>
        ...
        {isManagerOrAdmin && (
          <section id="guide-gestionnaire">
            <h2 className="text-lg font-semibold text-bark mb-3">Guide gestionnaire</h2>
            <p className="text-sm text-bark-muted mb-4">
