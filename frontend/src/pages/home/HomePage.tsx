    ...
    <Card variant="accent" padding="lg">
      ...
      <div className="space-y-2 text-sm text-bark-light">
        ...
        {edition.declarationDeadline && (
          <div className="flex items-start gap-2">
            <svg className="w-4 h-4 text-warning-strong shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <>
      ...
      <Card variant="default" padding="lg" className="mb-8 max-w-2xl mx-auto">
        ...
        <div className="space-y-4">
          {[
            { step: '1', text: 'Déposez vos articles lors des créneaux prévus', color: 'bg-info-soft text-primary' },
            { step: '2', text: 'Nos bénévoles assurent la vente au public', color: 'bg-warning-deep text-secondary' },
            { step: '3', text: 'Récupérez vos invendus et votre reversement', color: 'bg-warning-soft text-warning-strong' },
          ].map((item) => (
  ...
  return (
    <>
      ...
      {edition ? (
        <div className="mb-8">
          {edition.isTraining && (
            <div className="mb-3 bg-warning-soft border border-accent/30 text-warning-strong px-4 py-2.5 rounded-xl text-sm font-medium">
